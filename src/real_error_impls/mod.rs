...
#[derive(Serialize, Deserialize, RustcEncodable, RustcDecodable, Debug)]
pub enum RealError {
...
impl Error for RealError {
    fn description(&self) -> &str {
        use self::RealError::*;
        match *self {
            __Nonexhaustive => "__Nonexhaustive: This value should never exist. If you are seeing this, it may be a result of corrupt data, or an attempt to crash the program with bad data.",
        }
    }
